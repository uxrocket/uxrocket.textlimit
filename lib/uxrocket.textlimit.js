...
(function($) {
    ...
    var ux, // local shorthand
        ...
        events = {
            ...
            focus: 'focus.uxTextLimit',
            input: 'input.uxTextLimit'
        },
        ns = {
            rocket       : 'uxRocket',
            data         : 'uxTextLimit',
    ...
    var charCount = function($el, $remaining) {
        ...
        // if maxLength is 0, then do not check for limit.
        if(_opts.maxLength == 0){
            return;
        }
    ...
    ux.update = function(el) {
        ...
        $el.each(function() {
            ...
            _instance.maxLength = parseInt(_this.attr('maxlength')) || _instance.maxLength;
    ...
    ux.remove = function(el){
        ...
        $el.each(function() {
            ...
            _this.next('.' + ns.remaining).remove();
